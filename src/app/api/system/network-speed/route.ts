...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    speedCache.effectiveSpeed = Math.min(speedCache.interfaceSpeed || 1000, ispSpeed)
    ...
    return NextResponse.json({ success: false, error: 'Failed to save ISP speed' }, { status: 500 })
  }
}
