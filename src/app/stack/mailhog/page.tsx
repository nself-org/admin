...
function MailhogContent() {
  ...
  return (
    <PageShell title="Mailhog" description="Email testing and development SMTP service.">
            ...
            <CardContent className="pt-4">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="font-medium text-destructive">Stop Mailhog?</p>
                  <p className="text-sm text-red-700 dark:text-red-300">
                    Stopping Mailhog will disable email capture during development.
                  </p>
