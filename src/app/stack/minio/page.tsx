...
function MinioContent() {
  ...
  return (
    <PageShell title="MinIO" description="S3-compatible object storage management.">
            ...
            <CardContent className="pt-4">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="text-destructive font-medium">Stop MinIO?</p>
                  <p className="text-sm text-red-700 dark:text-red-300">
                    Stopping MinIO will make file uploads and storage unavailable.
                  </p>
