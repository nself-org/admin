...
function AuthContent() {
  ...
  return (
    <PageShell title="Auth" description="Authentication service management.">
            ...
            <CardContent className="pt-4">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="font-medium text-destructive">Stop Auth service?</p>
                  <p className="text-sm text-red-700 dark:text-red-300">
                    Stopping Auth will prevent all login and session operations.
                  </p>
