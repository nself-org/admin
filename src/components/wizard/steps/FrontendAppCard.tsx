        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (app1) app1.name = e.target.value.toLowerCase().replace(/[^a-z0-9_]/g, '')
              setConfig({ ...config, frontendApps: updatedApps })
            }}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              if (app2) app2.tablePrefix = e.target.value.toLowerCase().replace(/[^a-z0-9_]/g, '')
              setConfig({ ...config, frontendApps: updatedApps })
            }}
            className="w-full rounded border border-zinc-300 bg-white px-2 py-1 text-sm text-zinc-900 dark:border-zinc-600 dark:bg-zinc-800 dark:text-white"
            placeholder="app_"
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={(e) => {
                ...
                if (app5) app5.subdomain = e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, '')
                setConfig({
                  ...config,
