...
function NginxContent() {
  ...
  return (
    <PageShell title="Nginx" description="Nginx reverse proxy and SSL terminator management.">
            ...
            <CardContent className="pt-4">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="font-medium text-destructive">Stop Nginx?</p>
                  <p className="text-sm text-red-700 dark:text-red-300">
                    Stopping Nginx will take down all HTTP/HTTPS traffic routing.
                  </p>
