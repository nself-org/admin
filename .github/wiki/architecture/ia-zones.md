...
The Admin UI v2 (P94 modernization) is organized into 17 distinct zones. Each zone corresponds to a section of the ɳSelf CLI surface. The goal is full 47-command CLI surface coverage, every CLI command must be reachable through the Admin UI.
