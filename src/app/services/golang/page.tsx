...
function GolangContent() {
  ...
  const fetchServices = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/nself', {
        ...
        body: JSON.stringify({ command: 'service', args: ['ps', '--type', 'golang'] }),
      })
  ...
  return (
    <PageShell title="Go Services" description="Manage Go microservices registered with nSelf.">
          ...
          <Card className="border-destructive">
            <CardContent className="pt-6">
              <div className="flex items-start gap-2 text-destructive">
                ...
                <div>
                  <p className="font-medium">Failed to load Go services</p>
