...
function RedisContent() {
  ...
  return (
    <PageShell title="Redis" description="Redis cache and session store management.">
            ...
            <CardContent className="pt-4">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="font-medium text-destructive">Stop Redis?</p>
                  <p className="text-sm text-red-700 dark:text-red-300">
                    Stopping Redis will clear the cache and interrupt session-dependent services.
                  </p>
