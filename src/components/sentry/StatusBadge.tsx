...
const STATUS_CONFIG: Record<SentryStatus, { label: string; dotClass: string; badgeClass: string }> =
  {
    operational: {
      label: 'Operational',
    ...
    maintenance: {
      ...
      badgeClass: 'border-nself-border bg-nself-bg/40 text-nself-text-muted',
    },
  }
