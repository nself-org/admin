...
function PostgresqlContent() {
  ...
  return (
    <PageShell title="PostgreSQL" description="PostgreSQL database service management.">
            ...
            <CardContent className="pt-4">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="font-medium text-destructive">Stop PostgreSQL?</p>
                  <p className="text-sm text-red-700 dark:text-red-300">
                    Stopping the database will affect all services that depend on it.
                  </p>
