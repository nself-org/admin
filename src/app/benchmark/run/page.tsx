...
function RunBenchmarkContent() {
  ...
  const [phase, setPhase] = useState<'idle' | 'warmup' | 'running' | 'complete'>('idle')
        ...
        <div className="mb-8 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <div className="mb-6">
            ...
            <div className="grid gap-3 md:grid-cols-3">
              {(['api', 'database', 'full'] as BenchmarkTarget[]).map((target) => {
            ...
            <div className="mb-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium text-zinc-900 dark:text-white">
                  {phase === 'warmup' ? 'Warming up...' : 'Running benchmark...'}
                </span>
              </div>
          ...
          <div className="mb-8 rounded-xl border border-green-200 bg-green-50 p-6 dark:border-green-800 dark:bg-green-900/20">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-lg bg-white p-4 dark:bg-zinc-800">
                ...
                <p className="text-sm text-zinc-500">{result.requests.failed} failed</p>
              </div>
              <div className="rounded-lg bg-white p-4 dark:bg-zinc-800">
                ...
                <p className="text-sm text-zinc-500">P95: {result.latency.p95.toFixed(1)}ms</p>
              </div>
              <div className="rounded-lg bg-white p-4 dark:bg-zinc-800">
        ...
        <div className="mt-8 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <div className="space-y-2 font-mono text-sm">
            <p className="text-zinc-600 dark:text-zinc-400">
              <span className="text-sky-500">nself bench --target={config.target}</span> - Run{' '}
              {config.target} benchmark
            </p>
            <p className="text-zinc-600 dark:text-zinc-400">
              <span className="text-sky-500">nself bench --duration={config.duration}</span> - Set
              duration
            </p>
            <p className="text-zinc-600 dark:text-zinc-400">
              <span className="text-sky-500">nself bench --concurrency={config.concurrency}</span> -
              Set concurrency
            </p>
          </div>
        </div>
