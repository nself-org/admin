...
import { AlertCircle, ArrowLeft, Box, CheckCircle, FileCode, Rocket, Terminal } from 'lucide-react'
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-semibold text-white">Deploy to Kubernetes</h1>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-white">Deploy to Kubernetes</h1>
          <p className="text-sm text-zinc-400">Deploy your manifests to the cluster</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-zinc-700/50 bg-zinc-800/50 p-4">
                <h2 className="mb-4 font-semibold text-white">Deployment Options</h2>

                <div className="space-y-4">
                  <div>
                    <label className="mb-1 block text-sm text-zinc-400">Target Namespace</label>
                    <select
              ...
              <div className="rounded-lg border border-zinc-700/50 bg-zinc-800/50">
                <div className="border-b border-zinc-700/50 p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="font-semibold text-white">Deployment Progress</h2>
                  </div>
                </div>
                    ...
                    <div className="space-y-3">
                      {deploymentSteps.map((step, index) => (
                        ...
                        >
                          ...
                          {step.message && (
                            <span className="text-sm text-zinc-500">{step.message}</span>
                          )}
                        </div>
                      ))}
                    </div>
                    ...
                    {isDeploymentComplete && (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <CheckCircle
                            className={`h-6 w-6 ${dryRun ? 'text-blue-400' : 'text-emerald-400'}`}
                          />
                          <div>
                            <h3
                            ...
                            >
                              {dryRun ? 'Dry Run Complete' : 'Deployment Successful!'}
                            </h3>
